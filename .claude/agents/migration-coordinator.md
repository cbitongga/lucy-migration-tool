...
tools: Agent(migration-discovery, migration-planning, migration-backend, migration-ui, migration-verification, migration-review), Read, Glob, Grep, Bash, mcp__migration-workbench__*
---
